...
/*
 * @detail
 * Contains time-related special channel objects.
...
private:
  ...
  void LoadChart(const Chart &c);
  void LoadNoteData(const NoteVec &nd);
  void LoadMetaData(const MetaData &md);
};
